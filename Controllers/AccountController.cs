...
using Boa.Sample.Models.AccountViewModels;
...
namespace Boa.Sample.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            BoaIntegrationDbContext context,
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> BoaLogin(string returnUrl = null)
        {
            // Clear the existing external cookie to ensure a clean login process
            await HttpContext.SignOutAsync(IdentityConstants.ExternalScheme);
            ...
            string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                var userModel = _context.Users.FirstOrDefault(x => x.Email == user.Email);
                if (userModel != null)
                {
                    userModel.Token = CalculateMD5Hash(user.Email);
                    _context.SaveChanges();
                }
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult BoaRegister(string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailConfirmationAsync(_emailSettings, model.Email, callbackUrl);
            ...
            string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new User {UserName = model.Email, Email = model.Email, IsActive = true};
    ...
    public class BoaOptions {
        public static string ConfigurationKey => "BoaOptions";
